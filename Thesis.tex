...
%\usepackage{arabtex}  % Removed: causes 'loading package in a group' with modern LaTeX
%\setcode{utf8}
...
% \startsinglespace
\input{committee} %in the committee.tex put the image of the certification of approval%
\pagebreak
...
\input{chapters/ch5_experimental_evaluation}
\input{chapters/ch6_conclusion_future}
